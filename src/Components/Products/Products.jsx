...
import Img2 from "../../assets/p-4.jpg";
import Img3 from "../../assets/p-9.jpg";
import Img4 from "../../assets/p-7.jpg";
import Img5 from "../../assets/p-3.jpg";
      ...
      <div className="container bg-gray-100 shadow-lg">
        ...
        <div className="text-center mb-10 max-w-[600px] mx-auto">
          ...
          <p data-aos="fade-up" className="text-md text-gray-400">
            ...
            asperiores modi Sit asperiores modify
          </p>
        </div>
        {/* Body section */}
        <div>
          ...
          <button className="bg-blue-700 hover:scale-105 duration-300 text-white py-1 px-4 
